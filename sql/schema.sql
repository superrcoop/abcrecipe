...
insert into Uploads(user_name, recipe_id) values("Qlpavcniun.Nhuzuogg",1,"7514-08-14");
insert into Uploads(user_name, recipe_id) values("Qlpavcniun.Nhuzuogg",2,"3212-05-05");
insert into Uploads(user_name, recipe_id) values("Fuipmwqkwv.Neqecedpo",3,"6662-06-04");
insert into Uploads(user_name, recipe_id) values("Fuipmwqkwv.Neqecedpo",4,"9875-01-25");
insert into Uploads(user_name, recipe_id) values("Dvmckm.Qjnfqcvm",5,"9157-04-16");
insert into Uploads(user_name, recipe_id) values("Dvmckm.Qjnfqcvm",6,"5754-12-12");
insert into Uploads(user_name, recipe_id) values("Fzeklobgur.Tyich",7,"4667-12-11");
insert into Uploads(user_name, recipe_id) values("Fzeklobgur.Tyich",8,"6593-06-25");
insert into Uploads(user_name, recipe_id) values("Hinlhic.Hrgpt",9,"7169-04-11");
insert into Uploads(user_name, recipe_id) values("Hinlhic.Hrgpt",10,"7437-05-21");
insert into Uploads(user_name, recipe_id) values("Scill.Qlebqyinh",11,"1558-05-25");
insert into Uploads(user_name, recipe_id) values("Scill.Qlebqyinh",12,"6151-03-15");
insert into Uploads(user_name, recipe_id) values("Uzphs.Ssxjk",13,"7362-11-25");
insert into Uploads(user_name, recipe_id) values("Uzphs.Ssxjk",14,"1748-07-15");
insert into Uploads(user_name, recipe_id) values("Knpbhf.Erwiixfb",15,"8346-02-14");
insert into Uploads(user_name, recipe_id) values("Knpbhf.Erwiixfb",16,"4998-06-22");
insert into Uploads(user_name, recipe_id) values("Psycfk.Muupmez",17,"3667-04-26");
insert into Uploads(user_name, recipe_id) values("Psycfk.Muupmez",18,"3536-10-05");
insert into Uploads(user_name, recipe_id) values("Tiosdou.Qkelfyqtir",19,"6949-12-26");
insert into Uploads(user_name, recipe_id) values("Tiosdou.Qkelfyqtir",20,"5545-11-15");
