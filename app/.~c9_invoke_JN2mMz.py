...
class reg_Form(FlaskForm):
    ...
    user_name = StringField('Username', validators=[Length(min=1,max=40,message=('Username does not satisfy condition ( 1 < name.length <= 40 )')),Required('Please provide a username')])
